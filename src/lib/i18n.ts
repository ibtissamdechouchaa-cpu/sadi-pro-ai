...
const translations: Record<Locale, TranslationKeys> = {
  en: {
    ...
    legalResearch: 'AI Legal Research',
    legalResearchDesc: 'Search laws, regulations and standards...',
    quickSearch: 'Quick Search',
    deepResearch: 'Deep Legal Research',
    findRelated: 'Find Related',
    findRetentionRules: 'Find Retention Rules',
    importToKB: 'Import to Knowledge Base',
    importing: 'Importing...',
    imported: 'Imported',
    importSuccess: 'Reference imported successfully',
    ignore: 'Ignore',
    ...
    gazetteNumber: 'Official Gazette',
    articles: 'Articles',
    ...
    unverifiedReferences: 'Unverified References',
    ...
    legalHoldCreate: 'Create Legal Hold',
    holdName: 'Hold Name',
    holdReason: 'Reason',
    ...
    noHolds: 'No active legal holds',
    retentionCandidates: 'Retention Candidates',
    approve: 'Approve',
    reject: 'Reject',
  ...
  ar: {
    ...
    legalResearch: 'البحث القانوني الذكي',
    legalResearchDesc: 'ابحث عن القوانين والتنظيمات والمعايير...',
    quickSearch: 'بحث سريع',
    deepResearch: 'بحث قانوني معمق',
    findRelated: 'بحث متrelated',
    findRetentionRules: 'قواعد الاحتفاظ',
    importToKB: 'استيراد إلى قاعدة المعرفة',
    importing: 'جارٍ الاستيراد...',
    imported: 'تم الاستيراد',
    importSuccess: 'تم استيراد المرجع بنجاح',
    ignore: 'تجاهل',
    ...
    gazetteNumber: 'الجريدة الرسمية',
    articles: 'المواد',
    relatedTexts: 'نصوص مرتبطة',
    searchHistory: 'سجل البحث',
    viewDetails: 'عرض التفاصils',
    searchResults: 'نتائج البحث',
    noResults: 'لم يتم العثور على نتائج',
    unverified: 'غير موثق',
    needsReview: 'يحتاج مراجعة',
    sourceChanged: 'تغير المصدر',
    legalSources: 'المصادر القانونية',
    totalReferences: 'إجمالي المراجع',
    verifiedReferences: 'المراجع الموثقة',
    unverifiedReferences: 'المراجع غير الموثقة',
    ...
    missing: 'غير موجود',
    contradicted: 'متعارض',
    legalHoldCreate: 'إنشاء احتفاظ قانوني',
    holdName: 'اسم الاحتفاظ',
    holdReason: 'السبب',
    caseReference: 'مرجع القضية',
    releaseHold: 'إلغاء الاحتفاظ',
    cancelHold: 'إلغاء',
    activeHolds: 'احتفاظات نشطة',
    noHolds: 'لا توجد احتفاظات قانونية نشطة',
    retentionCandidates: 'مرشحات الاحتفاظ',
    approve: 'اعتماد',
    reject: 'رفض',
    complianceFrameworks: 'أطر الامتثال',
    framework: 'الإطار',
    overallScore: 'النتيجة الإجمالية',
    criticalGaps: 'فجوات حرجة',
  ...
  fr: {
    ...
    legalResearch: 'Recherche juridique IA',
    legalResearchDesc: 'Rechercher les lois, règlements et normes...',
    quickSearch: 'Recherche rapide',
    deepResearch: 'Recherche juridique approfondie',
    findRelated: 'Trouver apparentés',
    findRetentionRules: 'Règles de rétention',
    importToKB: 'Importer dans la base',
    importing: 'Importation...',
    imported: 'Importé',
    importSuccess: 'Référence importée avec succès',
    ignore: 'Ignorer',
    ...
    gazetteNumber: 'Journal officiel',
    articles: 'Articles',
    relatedTexts: 'Textes apparentés',
    ...
    totalReferences: 'Total des références',
    verifiedReferences: 'Références vérifiées',
    unverifiedReferences: 'Références non vérifiées',
    ...
    legalHoldCreate: 'Créer une conservation légale',
    holdName: 'Nom de la conservation',
    holdReason: 'Raison',
    caseReference: "Référence de l'affaire",
    releaseHold: 'Libérer la conservation',
    cancelHold: 'Annuler la conservation',
    activeHolds: 'Conservations actives',
    noHolds: 'Aucune conservation légale active',
    retentionCandidates: 'Candidats de rétention',
    approve: 'Approuver',
    reject: 'Rejeter',
