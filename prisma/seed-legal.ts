  ...
  const laws = [
    {
      ...
      isGlobal: true,
      organizationId: null,
      officialSource: "Journal Officiel n° 4",
      officialGazetteNumber: "4",
      ...
      summaryAr: "تنظيم دورة حياة الوثيقة، الحفظ، التحويل والإقصاء. القانون الأساسي المنظم للأرشيف في الجزائر. يُحدد تصنيف الوثائق وشروط الوصول وآجال الاحتفاظ بها.",
      description: "Loi organique réglementant la gestion des archives nationales : cycle de vie des documents, conservation, transfert et élimination. Classification des documents, délais de conservation et conditions d'accès.",
    },
    {
      ...
      keywords: ["حماية البيانات", "خصوصية", "بيانات شخصية", "حماية المعطيات الشخصية", "protection des données", "données personnelles"],
      ...
      description: "Loi relative à la protection des personnes physiques dans le traitement des données à caractère personnel. Protection de la vie privée, consentement, droits des personnes.",
    },
    {
      ...
      summaryAr: "التوقيع الإلكتروني للوثائق والمصادقة عليها. التوقيع الإلكتروني والتصديق الإلكتروني.",
      description: "Loi réglementant la signature électronique et les services de certification. Légalité du signature électronique pour les documents.",
    },
    {
      referenceNumber: "15-05",
      referenceType: "law",
      ...
      description: "Loi relative à la cybercriminalité et à la protection des systèmes d'information. Protection contre les actes illicites contre les systèmes numériques.",
    },
    {
      ...
      keywords: ["جريمة إلكترونية", "أمن المعلومات", "تكنولوجيا المعلومات", "أمن الأنظمة", "cybersécurité", "sécurité informatique"],
      retentionRules: { minYears: 5, maxYears: 20, documentTypes: ["security_log", "incident_report"] },
      summaryAr: "الأمن وحماية الأنظمة والبيانات. القانون الجزائري الأول لمكافحة الجرائم المعلوماتية. أساس أمن أنظمة الأرشيف.",
      description: "Loi relative à la répression des infractions liées aux technologies de l'information et de la communication. Sécurité des systèmes et protection des données.",
    },
    {
      ...
      description: "Loi relative au commerce électronique et aux transactions numériques. Documents et transactions électroniques dans les entreprises.",
    },
    {
      ...
      description: "Loi relative à la protection du patrimoine culturel algérien. Protection des documents à valeur historique et patrimoniale.",
    },
    {
      ...
      description: "Loi relative aux biens nationaux et à la gestion du patrimoine public. Protection des documents établissant les droits et biens de l'État.",
    },
    {
      ...
      description: "Loi relative aux communications électroniques et aux télécommunications. Régulation des infrastructures de communication.",
    },
  ];
